    ...
    <div className="bg-gradient-to-b from-blue-100 to-white">
      <section className="pt-60">
        <div className="container mx-auto px-4">
          <h1 className="text-5xl font-bold text-center mb-12 text-[#11304c]">Get Involved</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {involvementOptions.map((option, index) => (
              <div key={index} className="bg-white rounded-lg shadow-lg p-8 flex flex-col items-center text-center transform hover:scale-105 transition duration-300">
                <option.icon className="w-16 h-16 text-blue-600 mb-6" />
                <h3 className="text-2xl font-semibold mb-4 text-[#11304c]">{option.title}</h3>
                <p className="text-gray-600 mb-6">{option.description}</p>
                <button className="mt-auto bg-blue-600 text-white font-bold py-3 px-6 rounded-full hover:bg-blue-700 transition duration-300">
                  Learn More
                </button>
              </div>
            ))}
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12 text-[#11304c]">Upcoming Events</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-blue-50 rounded-lg p-6">
              <h3 className="text-2xl font-semibold mb-2 text-[#11304c]">Youth Leadership Workshop</h3>
            ...
            <div className="bg-blue-50 rounded-lg p-6">
              <h3 className="text-2xl font-semibold mb-2 text-[#11304c]">Annual Fundraising Gala</h3>
            ...
            <div className="bg-blue-50 rounded-lg p-6">
              <h3 className="text-2xl font-semibold mb-2 text-[#11304c]">Community Health Fair</h3>
      ...
      <section className="py-20 bg-blue-50">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-8 text-[#11304c]">Ready to Make a Difference?</h2>
          <p className="text-xl mb-12 text-gray-700">
            Join us in our mission to empower youth and create positive change in communities.
          </p>
          <a href="#" className="inline-block bg-blue-600 text-white font-bold py-3 px-8 rounded-full hover:bg-blue-700 transition duration-300">
            Contact Us Today
          </a>
        </div>
      </section>
